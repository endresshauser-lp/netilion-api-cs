...
${nuget_cmd} install src/Netilion.Api/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Netilion.Api.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Netilion.Api.dll \
-recurse:'src/Netilion.Api/*.cs' \
-doc:bin/Netilion.Api.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Netilion.Api.dll was created successfully"
fi
