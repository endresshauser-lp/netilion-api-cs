...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocumentResponse : DocumentBase,  IEquatable<DocumentResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="downloadHref">the download link.</param>
        /// <param name="links">links.</param>
        public DocumentResponse(long? id = default(long?), NestedIDHref classification = default(NestedIDHref), NestedIDHref status = default(NestedIDHref), NestedIDHref tenant = default(NestedIDHref), string downloadHref = default(string), Links6 links = default(Links6), string name = default(string), string description = default(string), string number = default(string), string documentVersion = default(string), string validFrom = default(string), string validUntil = default(string)) : base(name, description, number, documentVersion, validFrom, validUntil)
        {
            this.Id = id;
        ...
        public NestedIDHref Classification { get; set; }
