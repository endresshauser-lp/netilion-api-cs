...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Links5 :  IEquatable<Links5>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Links5" /> class.
        /// </summary>
        /// <param name="assets">assets.</param>
        /// <param name="documents">documents.</param>
        /// <param name="purchaseOrders">purchaseOrders.</param>
        public Links5(Link assets = default(Link), Link documents = default(Link), Link purchaseOrders = default(Link))
        {
            this.Assets = assets;
        ...
        {
            return this.Equals(input as Links5);
        }

        /// <summary>
        /// Returns true if Links5 instances are equal
        /// </summary>
        /// <param name="input">Instance of Links5 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Links5 input)
        {
            if (input == null)
                return false;
