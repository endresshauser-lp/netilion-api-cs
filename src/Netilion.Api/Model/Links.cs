...
namespace Netilion.Api.Model
{
        ...
        public partial class Links :  IEquatable<Links>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="edgeDevices">edgeDevices.</param>
        /// <param name="specifications">specifications.</param>
        public Links(Link edgeDevices = default(Link), Link specifications = default(Link))
        {
        ...
        public Link EdgeDevices { get; set; }
        ...
        public bool Equals(Links input)
        {
            ...
            return 
                (
                    ...
                    this.EdgeDevices.Equals(input.EdgeDevices))
                ) && 
                (
