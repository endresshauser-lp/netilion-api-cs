...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CustomerResponse : CustomerBase,  IEquatable<CustomerResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CustomerResponse(long? id = default(long?), CompanyAddressResponse address = default(CompanyAddressResponse), string number = default(string), string name = default(string)) : base(number, name)
        {
            this.Id = id;
