...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocumentStatusResponse : DocumentStatusBase,  IEquatable<DocumentStatusResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public DocumentStatusResponse(long? id = default(long?), NestedIDHref tenant = default(NestedIDHref), string code = default(string), string name = default(string), string description = default(string)) : base(code, name, description)
        {
            this.Id = id;
            this.Tenant = tenant;
        }
