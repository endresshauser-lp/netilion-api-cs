...
namespace Netilion.Api.Model
{
        ...
        public partial class APIKeysResponse :  IEquatable<APIKeysResponse>, IValidatableObject
    {
        ...
        public APIKeysResponse(List<APIKeyResponse> apiKeys = default(List<APIKeyResponse>), Pagination pagination = default(Pagination))
        {
            // to ensure "apiKeys" is required (not null)
            if (apiKeys == null)
            {
                throw new InvalidDataException("apiKeys is a required property for APIKeysResponse and cannot be null");
            }
            else
            {
            ...
            if (pagination == null)
            {
                throw new InvalidDataException("pagination is a required property for APIKeysResponse and cannot be null");
            }
            else
            {
