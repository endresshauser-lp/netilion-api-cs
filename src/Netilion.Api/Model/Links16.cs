...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Links16 :  IEquatable<Links16>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Links16" /> class.
        /// </summary>
        /// <param name="products">products.</param>
        /// <param name="deliveries">deliveries.</param>
        /// <param name="documents">documents.</param>
        public Links16(Link products = default(Link), Link deliveries = default(Link), Link documents = default(Link))
        {
        ...
        {
            return this.Equals(input as Links16);
        }

        /// <summary>
        /// Returns true if Links16 instances are equal
        /// </summary>
        /// <param name="input">Instance of Links16 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Links16 input)
        {
            if (input == null)
                return false;
