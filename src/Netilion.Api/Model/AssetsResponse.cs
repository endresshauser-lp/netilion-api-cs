...
namespace Netilion.Api.Model
{
        ...
        public partial class AssetsResponse :  IEquatable<AssetsResponse>, IValidatableObject
    {
        ...
        public AssetsResponse(List<AssetResponse> assets = default(List<AssetResponse>), Pagination pagination = default(Pagination))
        {
            ...
            if (pagination == null)
            {
                throw new InvalidDataException("pagination is a required property for AssetsResponse and cannot be null");
            }
            else
            {
