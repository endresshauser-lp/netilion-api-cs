...
namespace Netilion.Api.Model
{
        ...
        public partial class NodeTypes :  IEquatable<NodeTypes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as NodeTypes);
        }

        /// <summary>
        /// Returns true if NodeTypes instances are equal
        /// </summary>
        /// <param name="input">Instance of NodeTypes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodeTypes input)
        {
            if (input == null)
                return false;
