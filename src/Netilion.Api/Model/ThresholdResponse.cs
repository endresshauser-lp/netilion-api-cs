...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ThresholdResponse :  IEquatable<ThresholdResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThresholdResponse" /> class.
        /// </summary>
        /// <param name="id">Id of object (required).</param>
        /// <param name="name">name of the threshold. The name of the threshold. (required).</param>
        /// <param name="description">description of the threshold. The description of the threshold..</param>
        /// <param name="key">key of the threshold. This key is related to the keys set in asset values. (required).</param>
        ...
        /// <param name="tolerance">the threshold tolerance, should be a positive value (required).</param>
        /// <param name="thresholdType">the threshold type, tree values can be given for now, &#x27;low&#x27; if the it is a lower threshold, &#x27;high&#x27; if it is an upper threshold and &#x27;deviation&#x27; if it is as deviation from reference values (required).</param>
        /// <param name="notification">Whether the threshold should send notifications when exceeded (required).</param>
        public ThresholdResponse(long? id = default(long?), string name = default(string), string description = default(string), string key = default(string), long? unitId = default(long?), float? value = default(float?), float? tolerance = default(float?), string thresholdType = default(string), bool? notification = default(bool?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ThresholdResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ThresholdResponse and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for ThresholdResponse and cannot be null");
            }
            else
            {
                this.Key = key;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for ThresholdResponse and cannot be null");
            }
            else
            {
                this.Value = value;
            ...
            if (tolerance == null)
            {
                throw new InvalidDataException("tolerance is a required property for ThresholdResponse and cannot be null");
            }
            else
            {
                this.Tolerance = tolerance;
            }
            // to ensure "thresholdType" is required (not null)
            if (thresholdType == null)
            {
                throw new InvalidDataException("thresholdType is a required property for ThresholdResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("notification is a required property for ThresholdResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThresholdResponse {\n");
        ...
        {
            return this.Equals(input as ThresholdResponse);
        }

        /// <summary>
        /// Returns true if ThresholdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ThresholdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThresholdResponse input)
        {
            if (input == null)
                return false;
