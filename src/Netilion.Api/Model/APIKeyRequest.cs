...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class APIKeyRequest : APIKeyBase,  IEquatable<APIKeyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APIKeyRequest" /> class.
        /// </summary>
        /// <param name="clientApplication">clientApplication.</param>
        public APIKeyRequest(NestedID clientApplication = default(NestedID), string validFrom = default(string), string validUntil = default(string), bool? disabled = false, string authenticationType = default(string), string description = default(string)) : base(validFrom, validUntil, disabled, authenticationType, description)
        {
