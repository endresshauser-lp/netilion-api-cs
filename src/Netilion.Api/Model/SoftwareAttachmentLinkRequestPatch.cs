...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SoftwareAttachmentLinkRequestPatch :  IEquatable<SoftwareAttachmentLinkRequestPatch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SoftwareAttachmentLinkRequestPatch" /> class.
        /// </summary>
        ...
        public SoftwareAttachmentLinkRequestPatch(string href = default(string), string contentDate = default(string), string remarks = default(string), NestedID software = default(NestedID))
        {
            // to ensure "href" is required (not null)
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for SoftwareAttachmentLinkRequestPatch and cannot be null");
            }
            else
            {
                this.Href = href;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SoftwareAttachmentLinkRequestPatch {\n");
        ...
        {
            return this.Equals(input as SoftwareAttachmentLinkRequestPatch);
        }

        /// <summary>
        /// Returns true if SoftwareAttachmentLinkRequestPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of SoftwareAttachmentLinkRequestPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SoftwareAttachmentLinkRequestPatch input)
        {
            if (input == null)
                return false;
