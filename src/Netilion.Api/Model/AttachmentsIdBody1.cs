...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AttachmentsIdBody1 :  IEquatable<AttachmentsIdBody1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentsIdBody1" /> class.
        /// </summary>
        /// <param name="file">the filedata to upload.</param>
        /// <param name="softwareId">the software id this software attachment belongs to.</param>
        ...
        public AttachmentsIdBody1(byte[] file = default(byte[]), long? softwareId = default(long?), string contentDate = default(string), string remarks = default(string))
        {
            this.File = file;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttachmentsIdBody1 {\n");
        ...
        {
            return this.Equals(input as AttachmentsIdBody1);
        }

        /// <summary>
        /// Returns true if AttachmentsIdBody1 instances are equal
        /// </summary>
        /// <param name="input">Instance of AttachmentsIdBody1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttachmentsIdBody1 input)
        {
            if (input == null)
                return false;
