...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NotificationResponse : NotificationBase,  IEquatable<NotificationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public NotificationResponse(long? id = default(long?), Links14 links = default(Links14), string name = default(string), string content = default(string), string startDatetime = default(string), string endDatetime = default(string)) : base(name, content, startDatetime, endDatetime)
        {
            this.Id = id;
            this.Links = links;
        }
