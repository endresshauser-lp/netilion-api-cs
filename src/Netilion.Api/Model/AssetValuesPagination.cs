...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetValuesPagination :  IEquatable<AssetValuesPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetValuesPagination" /> class.
        /// </summary>
        ...
        public AssetValuesPagination(int? totalCount = default(int?), int? pageCount = default(int?), int? perPage = default(int?), int? page = default(int?), string prev = default(string), string next = default(string), string first = default(string), string last = default(string))
        {
            // to ensure "totalCount" is required (not null)
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for AssetValuesPagination and cannot be null");
            }
            else
            {
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for AssetValuesPagination and cannot be null");
            }
            else
            {
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for AssetValuesPagination and cannot be null");
            }
            else
            {
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for AssetValuesPagination and cannot be null");
            }
            else
            {
                this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetValuesPagination {\n");
        ...
        {
            return this.Equals(input as AssetValuesPagination);
        }

        /// <summary>
        /// Returns true if AssetValuesPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetValuesPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetValuesPagination input)
        {
            if (input == null)
                return false;
