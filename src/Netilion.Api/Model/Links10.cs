...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Links10 :  IEquatable<Links10>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Links10" /> class.
        /// </summary>
        ...
        public Links10(Link assets = default(Link), Link documents = default(Link), Link instrumentations = default(Link), Link specifications = default(Link))
        {
            // to ensure "assets" is required (not null)
            if (assets == null)
            {
                throw new InvalidDataException("assets is a required property for Links10 and cannot be null");
            }
            else
            {
                this.Assets = assets;
        ...
        {
            return this.Equals(input as Links10);
        }

        /// <summary>
        /// Returns true if Links10 instances are equal
        /// </summary>
        /// <param name="input">Instance of Links10 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Links10 input)
        {
            if (input == null)
                return false;
