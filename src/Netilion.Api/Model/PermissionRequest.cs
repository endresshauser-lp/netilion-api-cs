...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PermissionRequest : PermissionBase,  IEquatable<PermissionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PermissionRequest" /> class.
        /// </summary>
        public PermissionRequest(string permissionType = default(string), Assignable assignable = default(Assignable), Permitable permitable = default(Permitable)) : base(permissionType, assignable, permitable)
        {
        }
