...
namespace Netilion.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AttachmentsIdBody :  IEquatable<AttachmentsIdBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentsIdBody" /> class.
        /// </summary>
        /// <param name="file">the filedata to upload.</param>
        /// <param name="documentId">the document this attachment belongs to.</param>
        ...
        public AttachmentsIdBody(byte[] file = default(byte[]), long? documentId = default(long?), string contentAuthor = default(string), string contentDate = default(string), string remarks = default(string), string languages = default(string))
        {
            this.File = file;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttachmentsIdBody {\n");
        ...
        {
            return this.Equals(input as AttachmentsIdBody);
        }

        /// <summary>
        /// Returns true if AttachmentsIdBody instances are equal
        /// </summary>
        /// <param name="input">Instance of AttachmentsIdBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttachmentsIdBody input)
        {
            if (input == null)
                return false;
